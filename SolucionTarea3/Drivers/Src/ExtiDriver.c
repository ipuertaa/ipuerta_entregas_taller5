...
void extInt_Config(EXTI_Config_t *extiConfig){
	...
	case 1: {
		/* SYSCFG_EXTICR1 */
        //Limpiamos la posición que deseamos configurar.
	...
	case 2: {
		/* SYSCFG_EXTICR1 */
        //Limpiar la posición a configurar
	...
	case 12: {
		...
		if(extiConfig->pGPIOHandler->pGPIOx == GPIOA){
			...
			SYSCFG->EXTICR[2] |= (SYSCFG_EXTICR4_EXTI12_PH);
	...
	case 13: {
		...
		if(extiConfig->pGPIOHandler->pGPIOx == GPIOA){
			...
			SYSCFG->EXTICR[2] |= (SYSCFG_EXTICR4_EXTI13_PH);
